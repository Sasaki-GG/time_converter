...
class TimeUnit:
    ...
    def norm_set_fuzzytime(self, match_raw=None):
        """
        月-规范化方法--该方法识别时间表达式单元的模糊属性:之前、之后、前后、无
        :return:
        """
        print ('Fuzzy {}'.format(match_raw))
        rule = u"(前阵子)|(之前)|(以前)"
        ...
        match = pattern.search(target_ma)
        print ('BB',match)
