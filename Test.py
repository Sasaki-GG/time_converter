...
res = tn.parse(target=u'下周五我有什么课')  # target为待分析语句
print(res)

res = tn.parse('星期日我有什么课')  # target为待分析语句
print(res)

res = tn.parse('八月十五号晚上我有什么课')  # target为待分析语句
print(res)

res = tn.parse(target=u'晚上8点到上午10点之间')  # target为待分析语句
print(res)

res = tn.parse(
    target=u'2013年二月二十八日下午四点三十分二十九秒',
    time_base='2013-02-28 16:30:29')  # target为待分析语句，timeBase为基准时间默认是当前时间
print(res)
print('====\n')
